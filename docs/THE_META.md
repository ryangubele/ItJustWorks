...
Most of those sticks are **loud**. You can't move. You can't look. You know something's wrong.

Stuck scenes are the quiet ones. No error, no crash, sometimes no symptom until a quest hours later won't advance and the internet tells you the save is dead. That's the switch It Just Works™ is for. Crashes, vanilla bugs, save bloat - good mods already own those, and you should run them. This is for the near-invisible thing that ends playthroughs.
...
A scene watchdog and a shovel for the quiet save-killer: stuck scenes. It watches, names what you're in, warns when you've been there too long, and hands you the button.
...
Eventually, with a little luck, a precision tool in the community's kit to help *you* win the meta.
...
Thanks to the MCM Helper and powerofthree teams, whose work this is built on. And to the authors of the rest of the toolkit - USSEP, ReSaver, the engine fixers and the others - because keeping a save alive is a team sport. To Todd and Bethesda: for a genuine and enduring masterpiece; and for the inspiration.
