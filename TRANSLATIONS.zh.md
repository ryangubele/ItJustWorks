...
- **游戏内弹出通知**——已翻译。看门狗提醒、"名称未开启"提示、Stop 结果以及热键读数，均遵循 MCM **Settings** 页面上的 **Notification language** 设置，涵盖全部十种语言；安装程序会根据你选择的菜单语言为其设定初始值。
...
**Notification language** 设置以各语言的英文名称列出这十种语言，这样无论你使用何种字体，下拉列表都保持可读。在这里找到你的语言（自上而下与下拉列表顺序一致）：
...
**菜单**语言跟随你的 Skyrim 游戏语言（安装时选定）；上面的 **Notification language** 则是 Settings 页面上一个独立的控制项。
